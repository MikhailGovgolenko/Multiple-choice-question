...
file_path = 'C:/Users/mamki/OneDrive/Рабочий стол/Учеба/5 семестр/Фотоника/Волоконный лазер/данные/beats_1,89.txt'
...
peak_times = [163.2, 180, 197.6, 214.8, 232.27, 249.4, 266.4, 283.6]
peak_amplitudes = [1.1958, 0.9656, 0.8064, 0.7267, 0.7031, 0.6891, 0.6565, 0.6424]
...
plt.title(f'Осциллограмма при токе накачки $I$ = 1,89 А', size=14)
plt.xlim([150, 450])
