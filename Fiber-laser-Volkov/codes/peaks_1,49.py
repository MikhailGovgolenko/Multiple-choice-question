...
file_path = 'C:/Users/mamki/OneDrive/Рабочий стол/Учеба/5 семестр/Фотоника/Волоконный лазер/данные/beats_1,49.txt'
...
peak_times = [1027.8, 1048.4, 1069, 1089.6, 1111.0, 1132.66]
peak_amplitudes = [1.1955, 0.7127, 0.619, 0.5908, 0.5673, 0.5571]
...
plt.title(f'Осциллограмма при токе накачки $I$ = 1,49 А', size=14)
plt.xlim([1000, 1300])
